...
namespace PathFinder.StreetViewing.Service
{
    ...
    /// </summary>
    public class GoogleRestService : AbstractRestService
    {
        ...
        public DirectionsStatusJson GetDirection(double  startLat, double startLng, double endLat, double endLng)
        {
            string start = getStringOfLocation(startLat, startLng);
            string end = getStringOfLocation(endLat, endLng);
